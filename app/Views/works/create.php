<div class="max-w-2xl mx-auto px-4 py-8 mb-20">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-4">Nova Obra</h1>
        <p class="text-sm text-gray-500">Preencha os dados do novo projeto.</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="<?= BASE_URL ?>/works/create" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required
                    ...
                    placeholder="Ex: Construção Residencial Silva">
            </div>
