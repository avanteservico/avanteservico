<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mb-20">
    ...
    <div class="mb-6">
        ...
        <div class="flex justify-between items-end">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Todas as Receitas</h1>
                <p class="text-gray-500">Receitas de todas as obras</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            <div class="text-gray-400 text-xs font-medium uppercase tracking-wider mb-1">Recebido</div>
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="text-2xl font-bold text-green-400">+ R$
